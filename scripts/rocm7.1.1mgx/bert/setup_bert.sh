...
if [[ "$ubuntu_version" == "24.04" && "$python_version" == "3.12" ]]; then
    ...
    echo -e "${BLBlue}[NOTE]:${NC} Downloading and installing ROCm-enabled PyTorch, TorchVision, TorchAudio, and Triton..."
    wget https://repo.radeon.com/rocm/manylinux/rocm-rel-7.1.1/torch-2.9.1%2Brocm7.1.1.lw.git351ff442-cp310-cp310-linux_x86_64.whl
    wget https://repo.radeon.com/rocm/manylinux/rocm-rel-7.1.1/torchvision-0.24.0%2Brocm7.1.1.gitb919bd0c-cp310-cp310-linux_x86_64.whl
    wget https://repo.radeon.com/rocm/manylinux/rocm-rel-7.1.1/triton-3.5.1%2Brocm7.1.1.gita272dfa8-cp310-cp310-linux_x86_64.whl
    wget https://repo.radeon.com/rocm/manylinux/rocm-rel-7.1.1/torchaudio-2.9.0%2Brocm7.1.1.gite3c6ee2b-cp310-cp310-linux_x86_64.whl
    ...
    pip3 install \
        ...
        torchaudio-2.9.0+rocm7.1.1.gite3c6ee2b-cp310-cp310-linux_x86_64.whl \
        triton-3.5.1+rocm7.1.1.gita272dfa8-cp310-cp310-linux_x86_64.whl
else
...
printf '\n' | mlcr get,ml-model,bert-large,_onnx --outdirname=/model --non-interactive --yes -j 
...
if [[ "$ubuntu_version" == "24.04" && "$python_version" == "3.12" ]]; then
    ...
    wget https://repo.radeon.com/rocm/manylinux/rocm-rel-7.1.1/tensorflow_rocm-2.19.1-cp312-cp312-manylinux_2_28_x86_64.whl
    pip install tensorflow_rocm-2.19.1-cp312-cp312-manylinux_2_28_x86_64.whl
elif [[ "$ubuntu_version" == "22.04" && "$python_version" == "3.10" ]]; then
    echo -e "${BLBlue}[NOTE]:${NC} Downloading and installing Tensorflow"
    wget https://repo.radeon.com/rocm/manylinux/rocm-rel-7.1.1/tensorflow_rocm-2.19.1-cp310-cp310-manylinux_2_28_x86_64.whl
    pip install tensorflow_rocm-2.19.1-cp310-cp310-manylinux_2_28_x86_64.whl
else
    echo -e "${BRed}[ERROR]:${NC} Invalid combination of Python and Ubuntu."
    exit 1
fi
