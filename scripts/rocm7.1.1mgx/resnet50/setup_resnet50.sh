...
if [[ "$ubuntu_version" == "24.04" && "$python_version" == "3.12" ]]; then
    pip install https://repo.radeon.com/rocm/manylinux/rocm-rel-7.1.1/onnxruntime_migraphx-1.23.1-cp312-cp312-manylinux_2_27_x86_64.manylinux_2_28_x86_64.whl
elif [[ "$ubuntu_version" == "22.04" && "$python_version" == "3.10" ]]; then
    pip install https://repo.radeon.com/rocm/manylinux/rocm-rel-7.1.1/onnxruntime_migraphx-1.23.1-cp310-cp310-manylinux_2_27_x86_64.manylinux_2_28_x86_64.whl
else
...
# ---------------------------------
echo -e "${BLBlue}[NOTE]:${NC} Switching CUDAExecutionProvider to MIGraphXExecutionProvider in ONNX script..."
sed -i -e 's/CUDAExecutionProvider/MIGraphXExecutionProvider/g' \
